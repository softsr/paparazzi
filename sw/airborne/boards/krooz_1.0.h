...
#define PWM_1AND4_RCC_IOP RCC_AHB1ENR_IOPBEN
#define PWM_2AND3_RCC_IOP RCC_AHB1ENR_IOPCEN
#define PWM_1AND4_GPIO GPIOB
#define PWM_2AND3_GPIO GPIOC
#define PWM_1AND4_Pins GPIO1|GPIO4
#define PWM_2AND3_Pins GPIO7|GPIO8
#define PWM1_OC TIM_OC4
#define PWM2_OC TIM_OC3
#define PWM3_OC TIM_OC2
#define PWM4_OC TIM_OC1
...
#define PWM_7AND8_Pins GPIO2|GPIO3
#define PWM7_OC TIM_OC4
#define PWM8_OC TIM_OC3
...
#define PWM_9AND10_Pins GPIO0|GPIO1
#define PWM9_OC  TIM_OC1
#define PWM10_OC TIM_OC2
