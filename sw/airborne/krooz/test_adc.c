...
static inline void main_init( void ) {
    ...
    adc_buf_channel(3, &adc3_buf, 0x20);
}
...
static inline void main_event_task( void ) {
  ...
  if (adc_new_data_trigger) {
    ...
    v1 = adc3_buf.sum/adc3_buf.av_nb_sample;
    //v1 = DefaultVoltageOfAdc((10*(adc3_buf.sum/adc3_buf.av_nb_sample)));
		v2 = adc0_buf.sum/adc0_buf.av_nb_sample;
