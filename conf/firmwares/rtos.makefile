...
SRC_FIRMWARE=firmwares/rtos
SRC_INCLUDE=firmwares/rtos/include
SRC_COMM_INCLUDE=firmwares/rtos/include/common/include
...
RTOS_INC = -I$(SRC_FIRMWARE) -I$(SRC_INCLUDE) -I$(SRC_COMM_INCLUDE) -I$(SRC_BOARD)


ap.ARCHDIR = $(ARCH)

# would be better to auto-generate this
$(TARGET).CFLAGS 	+= -DFIRMWARE=RTOS
...
# RTOS sources
ap.srcs    += $(SRC_FIRMWARE)/list.c
ap.srcs    += $(SRC_FIRMWARE)/queue.c
ap.srcs    += $(SRC_FIRMWARE)/tasks.c
ap.srcs    += $(SRC_FIRMWARE)/timers.c
